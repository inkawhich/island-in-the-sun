...
# NAI
#
# This file is used to create what we call a dictionary, which is nothing more than
#   a space-delimited text based list of full paths to images and the associated 
#   labels. This file will be used as input to the CNN for training and/or validation.
#
# Ex. 
#   /path/to/1.tif 0
#   /path/to/2.tif 1
...
# Output file name that will be created here
output_dict = os.path.abspath("train_dictionary.txt")
...
for line in f:
    ...
    if ((equalize == 1) and (label_cnt[0,0] > 550) and label == '0'):
...
if equalize == 1:
    print ("Number of Ignored 0's = {}".format(ignored_zeros))
